...
export const Character = () => {
	...
	return (
		<Container fluid>
			<Row>
				{store.people.map((arraycharacter, index) => (
					<Col key={index} md={3} className="mt-1 mb-1">
						<Card>
							<Card.Img variant="top" src="https://wallpaperaccess.com/full/3399933.jpg" />
							<Card.Body>
								<Card.Title>{arraycharacter.name}</Card.Title>
								<Card.Text>
									<strong>Genero: </strong>
									{arraycharacter.gender}
									<br />
									<strong>Color de Pelo: </strong>
									{arraycharacter.hair_color}
									<br />
									<strong>Color de Piel: </strong>
									{arraycharacter.skin_color}
									<br />
									<strong>Color de Ojos: </strong>
									{arraycharacter.eye_color}
									<br />
									<strong>Nacimiento: </strong>
									{arraycharacter.birth_year}
								</Card.Text>
							</Card.Body>
							<Card.Footer>
